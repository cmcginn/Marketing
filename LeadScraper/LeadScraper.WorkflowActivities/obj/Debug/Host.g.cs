...
namespace LeadScraper.WorkflowActivities {
    ...
    public partial class Host : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(Host).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(Host));
        ...
        private string FindResource() {
            string[] resources = typeof(Host).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Host.g.xaml") || resource.Equals("Host.g.xaml"))) {
                    return resource;
                }
            }
