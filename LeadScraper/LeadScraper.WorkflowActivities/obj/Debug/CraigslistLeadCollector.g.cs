...
namespace LeadScraper.WorkflowActivities {
    ...
    public partial class CraigslistLeadCollector : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        public System.Activities.OutArgument<System.Xml.Linq.XElement> postsElement {
            get {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(CraigslistLeadCollector).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(CraigslistLeadCollector));
        ...
        private string FindResource() {
            string[] resources = typeof(CraigslistLeadCollector).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".CraigslistLeadCollector.g.xaml") || resource.Equals("CraigslistLeadCollector.g.xaml"))) {
                    return resource;
                }
            }
