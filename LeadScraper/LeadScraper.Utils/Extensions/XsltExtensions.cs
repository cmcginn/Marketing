...
namespace LeadScraper.Utils.Extensions {
  public class XsltExtensions {
    public XPathNodeIterator GetCraigslistJobDetails( XPathNodeIterator input ) {
      input.MoveNext();
      ...
      var result = resultDocument.ToXmlDocument().CreateNavigator().Evaluate( "node()" ) as XPathNodeIterator;     
      return result;
    }
